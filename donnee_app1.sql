...
CREATE TABLE Utilisateur (
    ...
    UNIQUE KEY (Numero, Mot_de_passe)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
(1, 1, '2025-04-01', 'Lundi', '08:00:00', '10:00:00'),
(2, 2, '2025-04-02', 'Mardi', '10:30:00', '12:30:00'),
(3, 3, '2025-04-03', 'Mercredi', '14:00:00', '16:00:00'),
(4, 4, '2025-04-04', 'Jeudi', '08:00:00', '10:00:00'),
(5, 1, '2025-04-05', 'Vendredi', '11:00:00', '13:00:00'),
(6, 1, '2025-04-06', 'Samedi', '09:00:00', '11:00:00'),
(7, 2, '2025-04-07', 'Lundi', '13:30:00', '15:30:00'),
(8, 3, '2025-04-08', 'Mardi', '15:00:00', '17:00:00'),
(9, 1, '2025-04-09', 'Mercredi', '16:00:00', '18:00:00'),
(4, 4, '2025-04-10', 'Jeudi', '08:00:00', '10:00:00'),
(5, 1, '2025-04-11', 'Vendredi', '11:00:00', '13:00:00'),
(6, 1, '2025-04-12', 'Samedi', '09:00:00', '11:00:00'),
(7, 2, '2025-04-13', 'Lundi', '13:30:00', '15:30:00'),
(8, 3, '2025-04-14', 'Mardi', '15:00:00', '17:00:00'),
(9, 1, '2025-04-15', 'Mercredi', '16:00:00', '18:00:00'),
(4, 4, '2025-04-16', 'Jeudi', '08:00:00', '10:00:00'),
(5, 1, '2025-04-17', 'Vendredi', '11:00:00', '13:00:00'),
(6, 1, '2025-04-18', 'Samedi', '09:00:00', '11:00:00'),
(7, 2, '2025-04-19', 'Lundi', '13:30:00', '15:30:00'),
(8, 3, '2025-04-20', 'Mardi', '15:00:00', '17:00:00'),
(9, 1, '2025-04-21', 'Mercredi', '16:00:00', '18:00:00'),
(4, 4, '2025-04-22', 'Jeudi', '08:00:00', '10:00:00');
COMMIT;
...
INSERT INTO Etudiant (IP, Numero_carte_etu, Id_gpe_td, Nom, Prenoms, Niveau, Email, Numero, Adresse) 
VALUES 
...
SET AUTOCOMMIT=0;
INSERT INTO Administration (Id_adm, Nom, Prenoms, Email, Numero, Adresse)
VALUES
...
INSERT INTO Enseignant (Id_ens, Id_cours, Nom, Prenoms, Email, Numero, Adresse)
VALUES
...
-- SET AUTOCOMMIT=0;
-- INSERT INTO Presence (Id_pres,IP,Id_ens,Id_salle,Date_presence,Heure_debut,Heure_fin) VALUES
-- (1, 'KADA2508020001','ENS001',1,'2025-03-01', '08:00:00', '10:00:00');
-- COMMIT;
